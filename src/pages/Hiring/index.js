...
import { Grid, Figure, Content } from "./hiring.style";
import NextImage from "common/components/NextImage";
import Head from "next/head";
import React, { Fragment } from "react";
import Sticky from "react-stickynode";
import { ThemeProvider } from "styled-components";
import Hiring from "../../common/data/Hiring/index";
import Footer from "../../containers/WebAppMinimal/Footer";
import app from "common/assets/image/webAppMinimal/hiring.png";
          ...
          <Section>
            <Grid>
              <Content>
                ...
                />
                <Text content={Hiring.subHeading} />
              </Content>
              <Figure>
                <Fade up>
