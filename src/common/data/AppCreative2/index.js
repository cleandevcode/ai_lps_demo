...
export const footerTop = {
  about: {
    logo: siteLogo,
    text: `The Only AI Copywriting Tool specifically designed for Digital Agencies Firms Social Media Users and Small Businesses. It makes it fast & easy to create eye catching content & context for you business or individual use.`,
  },
  widgets: [
    {
      id: 2,
